...
for fold in fold_stances:
    ...
    model1.add(Dense(128,activation = 'tanh', input_shape = (344, )))
    model1.add(Dropout(0.7))
    model1.add(Dense(128,kernel_regularizer=regularizers.l2(0.01),name = 'hidden_layer'))#0.01
    model1.add(Activation(activation = 'tanh', name = 'activation_1')) #model1.add(Dense(64, activation='relu'))
    model1.add(Dropout(0.7))
